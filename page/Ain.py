...
def apply_custom_styles():
    ...
    <style>
        ...
        .section-header {
            ...
            border-left: 5px solid #4F46E5; padding-left: 15px; margin-top: 2rem;
        }
    </style>
...
def main():
    ...
    if df is not None:
        ...
        m1.metric("Total Disagreement", "191")
        ...
        c1, c2 = st.columns(2)
        with c1:
            fig = px.bar(long_df, x="Area Type", y="Count", color="Area Type",
                         title="<b>Disagreement by Area</b>",
